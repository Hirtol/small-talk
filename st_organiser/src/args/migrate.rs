...
//         async {
//             for (character, voice) in self.data.game_data.character_map.pin_owned().iter() {
//                 use st_db::entity::*;
//                 let write = self.game_db.writer().begin().await?;
//                 let to_add = characters::ActiveModel {
//                     id: Default::default(),
//                     character_name: character.clone().into_active_value(),
//                     character_gender: Default::default(),
...
//
//                 // Get lines
//                 let line_cache = self.data.line_cache.lock().await;
...
//                         let voice_am = voice_lines::ActiveModel {
//                             id: Default::default(),
//                             dialogue_id: dialogue_model.id.into_active_value(),
